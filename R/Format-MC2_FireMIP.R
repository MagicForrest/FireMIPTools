...
openFireMIPOutputFile_MC2 <- function(run, quantity, sta.info, verbose = TRUE) {
  ...
  grid.file <- system.file("gridfiles", "MC2_t63_landmask.nc", package = "FireMIPTools")
...
determineQuantities_MC2_FireMIP <- function(source, names){
...
MC2_FireMIP<- new("Format",
                   ...
                   determineQuantities = determineQuantities_MC2_FireMIP,
