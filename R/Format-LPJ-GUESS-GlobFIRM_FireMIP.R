...
############################################################################################################################
#' Open a LPJ_GUESS_GlobFIRM FireMIP output file
#'
#' Opens a .nc file from the LPJ_GUESS_GlobFIRM FireMIP output and sorts out the meta-data and dimensions and all that messy stuff.
...
openFireMIPOutputFile_LPJ_GUESS_GlobFIRM <- function(run, quantity, sta.info, verbose = TRUE) {
  ...
  # grid.file <- system.file("gridfiles", "LPJ_GUESS_GlobFIRM_grid.nc", package = "FireMIPTools")
  ...
  # monthly starting in 1700 -- LPJ_GUESS_GlobFIRM
...
determineQuantities_LPJ_GUESS_GlobFIRM_FireMIP <- function(source, names){
...
####################################################
########### LPJ_GUESS_GlobFIRM_FireMIP FORMAT ########################
####################################################
#' LPJ_GUESS_GlobFIRM-FireMIP Format objects
#'
#' @description \code{LPJ_GUESS_GlobFIRM_FireMIP} - a Format for reading LPJ_GUESS_GlobFIRM FireMIP model output
#'
...
LPJ_GUESS_GlobFIRM_FireMIP<- new("Format",
                   ...
                   determineQuantities = determineQuantities_LPJ_GUESS_GlobFIRM_FireMIP,
