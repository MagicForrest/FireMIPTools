...
openFireMIPOutputFile_LPJ_GUESS_GlobFIRM <- function(run, quantity, sta.info, file.name, verbose = TRUE) {
...
availableQuantities_LPJ_GUESS_GlobFIRM_FireMIP <- function(source, names){
